function night() {
    ...
    //post-card副标题
    add_byclassname("item-title", "color: aliceblue;");
    //首页文章展示底部色块
    ...
    //图片变暗
    add_byTagname("img", "-webkit-filter: brightness(50%) !important;filter: brightness(100%) !important;");
    //首页文章展示封面变暗
    add_byclassname("post-list-item-container", "-webkit-filter: brightness(100%) !important;filter: brightness(50%) !important;");
    //搜索图标样式
    ...
    //时光机卡片样式
    add_byclassname("card", "background-color: #5f636e;");
    add_byclassname("biaotis", "color: aliceblue;");
...
function day() {
    ...
    function sub_byTagname(tag_name, del_style) {
        ...
        for (i = 0, len = eml.length; i < len; i++) {
            ...
            var old_style = eml[i].style.cssText;
            eml[i].style.cssText = old_style - del_style;
            //eml[i].style.cssText = eml[i].style.cssText.replace("c","$")
            //console.log("ssss3333:",eml[i].style.cssText);
            }
        }
    }
    ...
    //所有超链接改变样式
    sub_byTagname("a", "color: rgb(219, 219, 226);");
    ...
    //post-card副标题
    sub_byclassname("item-title", "color: aliceblue;");
    //首页文章展示底部色块
    ...
    //时光机卡片样式
    sub_byclassname("card", "background-color: #5f636e;");
    sub_byclassname("biaotis", "color: aliceblue;");
